...
-- ANSI
-- 연결에 사용할 두 컬럼명이 같은 경우 USING(컬럼명)을 사용함
...
LEFT JOIN LOCATION ON(LOCATION_ID = LOCAL_CODE) -- 하동운 DEPT_TITLE과 LOCAL_NAME이 NULL이라 LEFT로
